...
class Dataset:
    ...
    def _drop_metadata_features(self):
        metadata_features = ['Z_Revenue', 'Z_CostContact']
    ...
    def _drop_unusual_classes(self):
        ...
        self.rm_df = self.rm_df[self.rm_df['Marital_Status'] != 'Absurd']
        self.rm_df = self.rm_df[self.rm_df['Marital_Status'] != 'YOLO']
    ...
    def _as_category(self):
        ...
        """
        for i in ['Marital_Status', 'AcceptedCmp3', 'AcceptedCmp4', 'AcceptedCmp5', 'AcceptedCmp1',
                  'AcceptedCmp2', 'Complain', 'Response']:
            self.rm_df[i] = self.rm_df[i].astype('category')
    ...
    def _days_since_customer(self):
        ...
        self.rm_df['Dt_Customer'] = self.rm_df['Dt_Customer'].apply(
            lambda x: (date.today() - (datetime.strptime(x, '%Y-%m-%d').date())) / timedelta(days=1))
